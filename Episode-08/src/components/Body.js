...
const Body =()=>{
  ...
  const fetchData = async()=>{
    ...
    //const data = await fetch("https://corsproxy.org/?https%3A%2F%2Fwww.swiggy.com%2Fdapi%2Frestaurants%2Flist%2Fv5%3Flat%3D17.4849003%26lng%3D78.4879809%26is-seo-homepage-enabled%3Dtrue%26page_type%3DDESKTOP_WEB_LISTING");
      ...
      <div className ="res-container">
       {
        filteredRestaurant.map((restaurant) =>(
         <Link to ={"/restaurants/" +restaurant.info.id}><RestaurantCard key = {restaurant.info.id}resData = {restaurant} /></Link> //mentioning key is crucial when we use map method & used "<Restauarant card ..../>" as a JSX element
        ))}
